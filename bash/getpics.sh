...
#get the tar file from web
test -f ~/Pictures/pics.tgz || wget -q -O ~/Pictures/pics.zip http://zonzorp.net/pics.tqz
test -f ~/Pictures/pics.tgz || tar zxvf -d ~/Pictures -o -q ~/Pictures/pics.tgz && rm ~/Pictures/pics.tgz
